package com.zzg.android_face_master.newFace.adapter;
...
public class ImagePreviewGraphAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImagePreviewGraphAdapter(Context context, ArrayList<Bitmap> bitmaps, ViewHolder.OnItemClickListener onItemClickListener) {
