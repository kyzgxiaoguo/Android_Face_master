...
import com.zzg.android_face_master.adapter.ImagePreviewAdapter;
import com.zzg.android_face_master.bean.CameraConfig;
import com.zzg.android_face_master.bean.FaceResultData;
import com.zzg.android_face_master.http.baidu.HttpUtil;
import com.zzg.android_face_master.http.resultbean.Requstbean;
import com.zzg.android_face_master.http.util.AuthService;
import com.zzg.android_face_master.http.util.HttpCheckNetWorkUtil;
import com.zzg.android_face_master.util.Base64Utils;
import com.zzg.android_face_master.util.BitmapUtils;
import com.zzg.android_face_master.util.CameraErrorCallback;
import com.zzg.android_face_master.util.ImageUtils;
import com.zzg.android_face_master.view.CameraView;
import com.zzg.android_face_master.view.CircleSurfaceView;
import com.zzg.android_face_master.view.RectangleView;
...
//    人脸截图后保存并显示
    ...
    private void init() {
        // 实例化人脸跟踪视图
        mFaceView = new RectangleView(this);
                ...
                switch (msg.what){
                    case 1:
                        ...
                        if (jsonObject.getString("error_code").equals("0")){
                            JSONObject object=JSON.parseObject(jsonObject.getString("result"));
                            float score=object.getFloat("score");
                                showAlertDialog(mContext, "对比相似度为：",score+"%", "确认", new DialogInterface.OnClickListener() {
                                    @Override
                            ...
                            showAlertDialog(mContext, "对比相似度为：", "0", "确认", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                }
                        ...
                        break;
                    case 2:
                        ivImageB.setImageBitmap(bitmapB);
                        break;
                        default:
                            break;
                }
...
//            bitmap = BitmapUtils.getRectBitmap(mCenterRect, bm, mPoint);
            if (!isRepeat){
                ...
                bitmapB=scaleBitmap;
                ivImageB.setImageBitmap(scaleBitmap);
                isRepeat=false;
            }
            mCamera.stopPreview();
            startPreview();
    ...
    private void upIDData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    result = HttpUtil.post(url, access_token, "application/json", json);
